                            ...
                            <div className="box-body p-5">
                                ...
                                <table className="w-full border border-gray-400">
                                    ...
                                    <h4 className="mt-8 mb-2">Related Products</h4>
                                        <p>
                                        Explore our featured motorcycles, starting with top models like the Yamaha Mio i125. More models coming soon
                                        </p>
                                    ...
                                    <Link to="/YamahaMioi125" className="block text-center"
                                        ...
                                        <div className="p-3 rounded shadow-md border border-gray-300 rounded-md">
                                            <img
                                                ...
                                                alt="Yamaha Mio i125"
                                            />
                                            <p className="text-sm font-medium hover:underline">Yamaha Mio i125</p>
                                            <p className="bg-red-500 text-white rounded p-3 mt-3 rounded-md">₱77,900.00</p>
                                        </div>
                                    </Link>
